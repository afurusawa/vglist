...
angular.module("app", [ "ngRoute" ]), angular.module("app").controller("gameController", [ "$scope", "$http", "$log", function(a, b, c) {
    ...
    a.$watchGroup([ "init", "rating", "hoursPlayed" ], function(c, e) {
        if (console.log(JSON.stringify(c[1]) + " " + JSON.stringify(e[1]) + ", " + JSON.stringify(c[2]) + " " + JSON.stringify(e[2])), 
        c[1] != e[1] && "undefined" != typeof e[1]) {
        ...
        if (c[2] != e[2] && "undefined" != typeof e[2]) {
        ...
        c[0] && !d && b.get("/" + a.init.userId + "/" + a.init.gameId).then(function(b) {
            ...
            a.gameState.playingNow = c.playingNow, d = !0;
        });
    }), a.rateButton = {
        visible: !0
    }, a.rateGame = function() {
        ...
        b.post("/addToGameList", e).then(function(b) {
            console.log("res: " + JSON.stringify(b, null, 4)), a.gameState.added = !0, a.gameState.addText = "added";
        });

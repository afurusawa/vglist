...
angular.module("app", [ "ngRoute" ]), angular.module("app").controller("gameController", [ "$scope", "$http", "$log", function(a, b, c) {
    c.log("game controller active"), a.userData = "", a.gameState = {
        ...
        console.log(JSON.stringify(c[0]) + " " + JSON.stringify(d[0])), a.gameState.added || !a.gameState.initRan) {
            if (c[1] != d[1] && "undefined" != typeof d[1]) {
            ...
            c[0].userId && !a.gameState.initRan && (console.log("KASDHKAJS " + typeof a.init.userId), 
            parseInt(a.init.userId) && b.get("/" + a.init.userId + "/" + a.init.gameId).then(function(b) {
